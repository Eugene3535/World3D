...
//          Depth buffering
            ...
            if (m_depthBuffer.attachment.format == VK_FORMAT_UNDEFINED)
            {
                ...
                m_depthBuffer.attachment.format = vktools::find_supported_format(formats, VK_IMAGE_TILING_OPTIMAL, VK_FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT_BIT, context->getPhysicalDevice()->getHandle());
            }
