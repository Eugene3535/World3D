...
void main()
{
    ...
    vec4 sand  = texture(texSand,  terrainTexCoord);
    vec4 spice = texture(texSpice, terrainTexCoord);
    vec4 stone = texture(texStone, terrainTexCoord);
    vec4 rock  = texture(texRock,  terrainTexCoord);
